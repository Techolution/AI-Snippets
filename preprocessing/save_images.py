...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 21 07:36:26 2023
...
def save_image_to_disk(tensor, file_names, output_dir, img_shape=None):
        ...
        for i_shape, file_name in zip(image_shape, file_names):
            ...
            output_file_name_a = os.path.join(output_dir, file_name)
            # cv2.imwrite(output_file_name_f, fuse)
            cv2.imwrite(output_file_name_a, average)
            print('Image Saved successful (Average_Version) at {}'.format(output_dir))
